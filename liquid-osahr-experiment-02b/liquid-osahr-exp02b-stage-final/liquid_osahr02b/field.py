"""Continuous topology-coupled state models for Liquid-OSAHR Experiment 02B.
...
def graph_view(graph: Hypergraph, index: PersistentIndex, scenario: Scenario) -> GraphView:
    ...
    vertices remain explicit in OSAHR but do not own liquid state in 02B.
    """
...
class FrozenOpenLoopNeuralField(FieldBase):
    """Open-loop neural field ablation for Experiment 02B.
